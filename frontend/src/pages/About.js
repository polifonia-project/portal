    ...
    <div div className={classes.aboutPageContainer}>
      ...
      <div className={classes.textContainer} id="portal-section">
        ...
        <p>The Polifonia H2020 project's web portal stands as a beacon of accessibility and knowledge, representing the culmination of the project's extensive research and technological innovations.
          ...
          <br /><br /> The web portal is the result of a collaborative effort, with the University of Bologna as the scientific and technical coordinator. Scientific coordination was provided by <a href='https://www.unibo.it/sitoweb/valentina.presutti' target='_blank' className={classes.customLink} rel="noopener noreferrer">Valentina Presutti</a>, project management by <a href='https://www.unibo.it/sitoweb/marilena.daquino2' target='_blank' className={classes.customLink} rel="noopener noreferrer">Marilena Daquino</a>, web development and design by <a href='https://www.unibo.it/sitoweb/marco.grasso7' target='_blank' className={classes.customLink} rel="noopener noreferrer">Marco Grasso</a>, and data management by <a href='https://www.unibo.it/sitoweb/giulia.renda3' target='_blank' className={classes.customLink} rel="noopener noreferrer">Giulia Renda</a>. Contributions were made by scholars, researchers and developers of The Open University, the National University of Ireland Galway, and King's College London.</p>
      </div>
